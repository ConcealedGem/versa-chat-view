...
export function Chat({
  ...
  return (
    <div ref={containerRef} className="flex h-screen w-full bg-white dark:bg-zinc-900"> {/* Main container: horizontal flex, full screen height */}
      ...
      {/* 可拖拽的分割条 */}
      <div
        className={`w-1 bg-gray-200 dark:bg-zinc-700 hover:bg-blue-400 dark:hover:bg-blue-500 cursor-col-resize transition-colors relative group ${
      ...
      >
        {/* Header/Status Bar for Right Panel */}
          ...
          <h2 className="text-base font-semibold text-gray-800 dark:text-gray-200">Talented individuals are always around, yet few can truly recognize and appreciate them.</h2>
                     <HeaderMenu 
             ...
             onAssistantChange={(assistant) => {
               console.log('Chat: 收到助手切换通知:', assistant);
               setCurrentAssistant(assistant);
               // 助手切换成功后，刷新工具列表
               console.log('Chat: 开始刷新工具列表');
               handleRefreshTools();
             }}
           />
        </div>
      ...
      {/* Login Modal (remains outside the main flex layout, as it's an overlay) */}
      <LoginModal
